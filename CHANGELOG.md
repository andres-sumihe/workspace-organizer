...
## Fixed
- resolve missing package on runtime
...
## Fixed
- Fix task updates section height that cause the updates cannot be scrolled
- Fix popout window failed to render the notes

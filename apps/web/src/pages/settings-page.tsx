...
export const SettingsPage = () => {
  ...
  const handleReset = () => {
    const defaults = {
      senderDN: 'ou=xxx,o=bankbebb,o=swift',
      senderFullName: 'BANKBEBBXXX',
      receiverDN: 'ou=xxx,o=bankbebb,o=swift',
      receiverFullName: 'BANKBEBBXXX'
    };
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="ou=xxx,o=bankbebb,o=swift"

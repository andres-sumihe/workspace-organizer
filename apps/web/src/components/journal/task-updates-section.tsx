...
// Shared date formatters from journal-parser
import { formatRelativeTime, formatTimestampDisplay } from '@/utils/journal-parser';

// Aliases for backward-compatible usage within this file
const formatUpdateDate = formatRelativeTime;

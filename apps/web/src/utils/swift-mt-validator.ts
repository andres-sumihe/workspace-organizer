 ...
 * Example: BANKBEBBAXXX (LT) -> BANKBEBBAXXX (full LT with identifier)
 * 
 ...
 *       Example: BANKBEBBAXXXN -> BIC11=BANKBEBBAXXX, LT=implicit, Priority=N
 * 
...
function parseBlock2(content: string): {
  ...
  if (direction === 'I') {
    ...
    // Example: I799BANKBEBBAXXXN2020
    //          I + 799 + BANKBEBBAXXX (12-char LT) + N + 2020

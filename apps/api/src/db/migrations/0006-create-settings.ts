...
export const up = async (db: Database.Database) => {
  db.exec(`
    ...
    INSERT OR IGNORE INTO settings (key, value_json, description) VALUES 
      ('validation.iso20022', '{"senderDN":"ou=xxx,o=bankbebb,o=swift","senderFullName":"BANKBEBBXXX","receiverDN":"ou=xxx,o=bankbebb,o=swift","receiverFullName":"BANKBEBBXXX"}', 'ISO20022 (MX) validation criteria'),
